        ...
        <div className="max-w-4xl mx-auto py-10">
            ...
            <div className="grid grid-rows py-10 px-3 md:grid-cols-2 gap-x-28 gap-y-10">
                <div className="bg-gray-100 rounded-md">
                    <img  src={menu[0].img} width="300" className="mx-auto" alt=""></img>
                    <div className="px-5 py-5">
                        <span className="block text-4xl text-gray-100 font-bold">{menu[0].name}</span>
                        <span className="block pt-3 text-gray-100  font-semibold">{menu[0].desc}</span>
                    </div>
                    <div className="px-5 py-1">
                        <span className="block text-yellow-500 text-4xl font-semibold">Rp. {menu[0].price}</span>
                    </div>
                    <div className="pt-10">
                        <Link to="/foodOrder"><button className="w-full rounded-md bg-gray-800 px-5 py-5 text-center font-bold text-gray-100 text-lg">
                            Pesan Sekarang
                        </button>
                        </Link>
                    </div>
                ...
                <div className="bg-gray-800 rounded-md">
                    <img  src={menu[1].img} width="300" className="mx-auto" alt=""></img>
                    <div className="px-5 py-5">
