...
const FoodOrder = () => {
    ...
    return (
        <div className="max-w-5xl mx-auto py-5 px-5 md:py-20 md:px-0">
            <div className="grid grid-rows gap-12 md:grid-cols-2 ">
                ...
                <div className="bg-gray-900 pt-10 md:pt-10 rounded-xl">   
                    ...
                    <div className="pt-10 rounded-lg">
                        <button className="border-2 border-gray-800 py-2 px-2 bg-gray-100 w-full font-gray-800 text-lg font-bold">Order</button>        
                    </div>           
